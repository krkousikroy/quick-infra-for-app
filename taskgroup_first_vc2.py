...
def main():
    ...
    parser.add_argument("--insecure", action="store_true", help="Disable TLS certificate verification for MTA API connections (default behavior)")
    parser.add_argument("--verify-cert", action="store_true", help="Enable TLS certificate verification for MTA API connections")
    ...
    verify = True if args.verify_cert else False
    if args.ca_bundle:
